...
async function getUsers() {
  ...
  const rolesByUserId: Record<string, Array<{ id: string; name: string; name_ar: string; status: string }>> = {}
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <PhoneInputField
                ...
                disabled={createMutation.isPending || updateMutation.isPending}
                placeholder={t('users.phonePlaceholder') || 'Enter phone number (optional)'}
